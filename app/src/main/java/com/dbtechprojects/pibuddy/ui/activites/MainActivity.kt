...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (intent.getStringExtra("IPAddress") != null) {
            ...
            mainActivityBinding.IPAddressText.setText(IP)
    ...
    private fun setupClicks() {
        mainActivityBinding.ConnectButton.setOnClickListener {
        ...
        mainActivityBinding.ScanButton.setOnClickListener {
    ...
    private fun setupDraw() {
        ...
        var toolbarid = mainActivityBinding.toolbar.id

        setSupportActionBar(mainActivityBinding.toolbar)
        drawer = findViewById(R.id.drawer_layout)
        val toggle = androidx.appcompat.app.ActionBarDrawerToggle(
            this, drawer, mainActivityBinding.toolbar,
        ...
        for ((key, value) in keys) {
            ...
            if (key == "adcount") {
                ...
                menu.add(0, 0, 0, key).setOnMenuItemClickListener {
                    ...
                    if (strJson != null) {
                        mainActivityBinding.IPAddressText.setText(key)
                        mainActivityBinding.UsernameText.setText(UsernameFromJson)
                        mainActivityBinding.PasswordText.setText(PasswordFromJson)
                    }
    ...
    private fun validateFields(): String {
        if (mainActivityBinding.IPAddressText.text.isEmpty()) {

            return "Missing IP"
        }
        if (mainActivityBinding.UsernameText.text.isEmpty()) {

            return "Missing Username"
        }
        if (mainActivityBinding.PasswordText.text.isEmpty()) {
